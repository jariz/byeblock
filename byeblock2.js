...
var customModules = [{
    ...
    func: function (module, b, require) {
        ...
        this.get = function (name) {
            ...
            if (name === "policy") {
                if(value === "SNIP" || value === "BLOCK") {
                    // console.log(this.attributes.title, name, value);
                    //always lie.
                    return "ALLOW";
                }
            } else if(name === "duration") {
                return this.attributes.full_duration;
        ...
        // var realSetup = this.setup;
        // this.setup = function (data) {
        //     //call real setup func
        //     var ret = realSetup.apply(this, arguments);
        //
        ...
        this.streamsUrl = function () {
            var url = this.getEndpointUrl("trackStreams", {id: this.id});
            var policy = this.attributes.policy;
